**Alice** é a atual rainha da [[Corte Cerúlea]]. Ela é a primeira mestiça (parte humana, parte fada, neste caso) a assumir o cargo. Sua estação é a primavera, mas, por certos motivos, ela também é associada ao inverno, embora em menor grau.
...
<figure align="center">
	<img src="/MundosNomades/img/VF+/NPCs/Alice.png" width="300" height="300" style="border: 1px solid black;" alt="Alice">
</figure>
...
!!! abstract "Perfil"
	...
	- **Alcunha(s):**
		- Rainha da Primavera
		- Dama das Crisálidas
	- **Espécie:** Meio-humana/Meio-fey *(Fada)*
	- **Gênero:** Feminino
	- **Ocupação:** Rainha da Primavera
